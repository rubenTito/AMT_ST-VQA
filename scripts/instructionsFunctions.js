...
function appendInstructions(project) {
	instructions = [
		...
		// ["<li>The questions can't be <span class='redText boldText'>ambiguous</span> and therefore, if they are asked to a second person he should answer exactly the same and with the <span class='boldText'>same words</span>. To help you with that we limit the maximum answer words allowed to 6/8, even though we recommend you to <span class='blueText'>not exceed 4</span>.</li>", "all"],
		["<li>The questions can't be <span class='redText boldText'>ambiguous</span> and therefore, if they are asked to a second person he should answer exactly the same and with the <span class='boldText'>same words</span>. To help you with that we limit the <span class='blueText'>maximum characters allowed in the answer to 60</span>.</li>", "all"],
		...
		["<li>Do not give people <span class='redText'>proper names</span> <span class='blueText'>unless it can be found in the image</span>.</li>", "comic"],
